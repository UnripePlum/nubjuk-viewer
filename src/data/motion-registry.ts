...
export const MOTION_REGISTRY: Record<MotionName, MotionEntry> = {
  ...
  sit:        { gif: "/motions/nubjuk-sit.gif",        duration_ms: 1500, loop: false },
  stand:      { gif: "/motions/nubjuk-stand.gif",      duration_ms: 1200, loop: false },
  roll_left:  { gif: "/motions/nubjuk-roll-left.gif",  duration_ms: 2000, loop: false },
  roll_right: { gif: "/motions/nubjuk-roll-right.gif", duration_ms: 2000, loop: false },
